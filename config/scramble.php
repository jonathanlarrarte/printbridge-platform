...
return [
     ...
     */
    // La seccion 6 del doc define la "API publica" como exactamente /v1/*.
    // /agente/* es explicitamente privado (seccion 6.1: "no son parte de la
    // API publica"), y /login, /logout, /health son infraestructura aparte
    // -- ninguno de los tres pertenece a esta documentacion.
    'api_path' => [
        'include' => ['v1'],
    ],
